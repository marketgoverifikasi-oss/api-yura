...
export default async function bratKobatoHandler(req: Request, res: Response) {
  ...
  try {
    const bgUrl =
      "https://raw.githubusercontent.com/kayzzaoshi-code/Uploader/main/file_1771728510134.jpeg"
    ...
    const maxWidth = 350
    const maxHeight = 250
    const centerX = canvas.width / 2 + 175
