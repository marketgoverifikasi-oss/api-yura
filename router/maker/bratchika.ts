...
export default async function bratchika(req, res) {
  try {
    ...
    const bgUrl = "https://raw.githubusercontent.com/kayzzaoshi-code/Uploader/main/file_1771527351581.jpeg"
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      let currentX = centerX - line.width / 2 + 125
